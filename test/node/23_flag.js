import { Window, loop, Vec3, Camera, NaiveScene, Vec2, Triangle, Image } from "../../src/index.node.js";
...
const texture = await Image.ofUrl("./assets/chapelle.jpg");
...
loop(({ dt }) => {
    camera
        ...
        .paint();
    flagPhysics(dt);
    window.setTitle(`Flag Simulation | Left Click: Interact | Right Click: Rotate Camera | FPS: ${Math.floor(1 / dt)}`);
}).play();
