import { Camera, IO, Parallel, Vec3, Mesh, Color, Scene, Utils } from "../../dist/node/index.js";
import os from "os";
...
(async () => {
    ...
    function bunny({ time, scene, width, height }) {
        ...
        const camera = new Camera({ sphericalCoords: Vec3(3, theta, 0) })
    ...
    const parallelImagesStream =
        Parallel
            ...
            .lazyInitialState(() => {
                ...
                const stanfordBunnyObj = fs.readFileSync("./assets/bunny.obj", { encoding: "utf-8" });
