import { Color, Vec2, Window, parseSVG, Image, IO, Box, Ray, loop, measureTime } from "../../src/index.node.js";
...
function drawSVGData() {
    ...
    for (let i = 0; i < paths.length; i++) {
        ...
        const box = boxes[i];
        const isInsideMethod = [isInsideCurve0, isInsideCurve1, isInsideCurve2, isInsideCurve3][2];
        image.mapBox((x, y) => {
